...
public class PersonManager implements IPersonService {
	...
	public void add(User user) {
		System.out.println("Kullanýcý Sisteme Baþarý Ýle Kaydedildi." + user.getFirstName() + " " + user.getLastName());

	}

	@Override
	public void update(User user) {
		System.out.println("Kullanýcý Bilgileri Baþarý Ýle Güncellendi." + user.getFirstName() + " " + user.getLastName());
